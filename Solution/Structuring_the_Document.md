# Day #24 - Structuring the Document
## Problem
...
+ `void initialize_document(char* text)` to intialise the document. You have to intialise the global variable `Doc` of type `struct document`.
