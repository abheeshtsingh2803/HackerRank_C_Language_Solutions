...
+ This query corresponds to calling the function char** kth_sentence_in_mth_paragraph.

3. The only line contains :

+ This query corresponds to calling the function char* kth_word_in_mth_sentence_of_nth_paragraph.
